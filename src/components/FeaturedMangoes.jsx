      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="lg:col-span-4 bg-gradient-to-br from-[#061e15] to-[#030f0a] border border-[#0d3d2c] rounded-3xl p-8 flex flex-col justify-between relative overflow-hidden group shadow-2xl">
            {/* TYPO FIXED HERE: Stripped out the rogue trailing curly bracket */}
            ...
            {FEATURED_BATCHES.map((batch) => (
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                  ...
                  <button className="w-full h-11 mt-2 bg-[#08241a] group-hover:bg-brand-orange text-[#0ed194] group-hover:text-[#04140e] border border-[#0ed194]/10 group-hover:border-transparent rounded-xl font-black text-xs tracking-wider uppercase transition-all duration-300 flex items-center justify-center gap-2 shadow-md">
